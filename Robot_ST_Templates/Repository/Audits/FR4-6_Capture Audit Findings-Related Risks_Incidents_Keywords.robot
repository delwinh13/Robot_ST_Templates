...
Capture Findings
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Add Button-{index}.png
    #Process Flow
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Process Flow Add Phase-{index}.png
    #Audit Elements
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Elements Selected and CheckBox-{index}.png
    #More Information
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings More Info & Description-{index}.png
    #Findings Owner
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Owner & Risk Source-{index}.png
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Classification & Risk-{index}.png
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Findings Supporting Documents Link Added-{index}.png
    sleep    1 second
    Select Frame                            ${iFrame}
    #Save to continue
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Process Flow Edit Phase-{index}.png
    #Close Audit Finding
...
#    Click Element                           ${AuditFindingsCloseYES}
    ...
    sleep   1 second
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Audit Findings Record Sub-Module-{index}.png
...
View Related Risks
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Risks and Incidents Panels-{index}.png
    #Related Risk Panel
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Related Risk Record in Viewing Grid-{index}.png
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Related Risk Record Opened and Risk Process Flow-{index}.png
...
View Related Incidents
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Related Incidents Record in Viewing Grid-{index}.png
    ...
    ${file1} =    Capture Page Screenshot    ${OUTPUTDIR}/Results/Related Incidents Record Opened and Incidents Process Flow-{index}.png